...
string(REPLACE "\n" " " IntelAltera_Link_Libs ${IntelAltera_Link_Libs})
string(REPLACE " " ";" IntelAltera_Link_Libs ${IntelAltera_Link_Libs})
list(FILTER IntelAltera_Link_Libs INCLUDE REGEX "-l.[a-zA-Z0-9-_]+" )
